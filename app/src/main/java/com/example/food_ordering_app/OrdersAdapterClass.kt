...
class OrdersAdapterClass(var items:MutableList<dish>,var context:Context,var application: Application):RecyclerView.Adapter<OrdersAdapterClass.ViewHolder>() {
